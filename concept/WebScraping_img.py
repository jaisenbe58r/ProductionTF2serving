...
if __name__ == '__main__':
    ...
    wd = webdriver.Chrome(chrome_options=options, executable_path=DRIVER_PATH)

    queries = ["lactarius deliciosus", "Lactarius sanguifluus", "Agaricus campestris", "Boletus Edulis", "Amanita Caesaera", "Cantharellus Cibarius", "Hygrophorus latitabundus", "cratarellus comucopioides"]  #change your set of querries here
    for query in queries:
        ...
        images_path = "C:/Users/AUTIS/Google Drive/10_MachineLearning_JS/Cursos/Curso_WebScraping/web-scraping-master/NIVEL 3/images"
        try:
            for i in links:
